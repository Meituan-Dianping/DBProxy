...
log_sql_backend_ex(sql_log_t *sql_log, network_mysqld_con *con)
{
    ...
    gfloat read_client_latency = 0.0, handle1_latency = 0.0, send_server_latency = 0.0, server_latency = 0.0,
            ...
            split_proto_latency = 0.0, split_new_latency = 0.0, split_append_latency = 0.0;
    ...
    split_append_latency = (con->conn_status_var.cur_query_split_pool_begin - con->conn_status_var.cur_query_split_proto_end)/1000.0;
    ...
    g_string_append_printf(message, "# C_begin:%s recv_client_latency:%.3f(ms) proxy_pre_expend:%.3f(ms) send_server_latency:%.3f(ms) "
            ...
            "split_pos_swap_head:%0.3f(ms) split_proto_latency:%0.3f(ms) split_new_latency:%0.3f(ms) split_append_latency:%0.3f(ms) %s %s:%s\n",
                                begin_time->str,
                                read_client_latency,
                                handle1_latency,
                                send_server_latency,
