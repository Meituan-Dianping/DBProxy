...
log_sql_backend_ex(sql_log_t *sql_log, network_mysqld_con *con)
{
    ...
    gfloat read_client_latency = 0.0, handle1_latency = 0.0, send_server_latency = 0.0, server_latency = 0.0,
            ...
            tokenize_latency = 0.0, split_latency = 0.0, analyze_latency = 0.0;
    ...
    g_string_append_printf(message, "# C_begin:%s recv_client_latency:%.3f(ms) proxy_pre_expend:%.3f(ms) send_server_latency:%.3f(ms) "
            "DB_expend:%.3f(ms) recv_server_latency:%.3f(ms) proxy_pos_expend:%.3f(ms) send_client_latency:%.3f(ms) total_latency:%.3f(ms) tokenize_latency:%0.3f(ms) analyze_latency:%0.3f(ms) split_latency:%0.3f(ms) %s %s:%s\n",
                                begin_time->str,
                                read_client_latency,
                                handle1_latency,
                                send_server_latency,
