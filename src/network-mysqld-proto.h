...
#define DEFAULT_DB_CONN_CHARSET UTF8_CHARSET_INDEX
#define DEFAULT_DB_CONN_CHARSET_STR "utf8"

#define MYSQL_PROTOCOL_NATIVE_PASSWORD_PLUGIN "mysql_native_password"
